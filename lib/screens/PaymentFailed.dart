...
class PaymentFailed extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    initTts();
    flutterTts.speak("Payment Failed. Please press lower part of the screen to make a new payment!. You will receive a haptic feedback when you go to the home page");
    return Scaffold(
      body: Center(
        child: Column(
          children: [
