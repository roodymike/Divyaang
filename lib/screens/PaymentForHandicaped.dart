...
class PaymentForHand extends StatefulWidget {
  @override
  _PaymentForHandState createState() => _PaymentForHandState();
}

enum TtsState { playing, stopped, paused, continued }

class _PaymentForHandState extends State<PaymentForHand> {
  ...
  initState() {
    super.initState();
    initTts();
    flutterTts.speak("You can start Payment by saying OK Pay, and I'll do it for you. Your current balance is 8458 dollars.");
            ...
            GestureDetector(
                ...
                onDoubleTap: () {
                  ...
                  Timer(Duration(seconds: 5), () {
                    _speak(
                        "Ok Paying 10 dollars. Please verify your identity using Face ID");
